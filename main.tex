...
\begin{center}
  \textbf{\Huge \textsc{Rolando S. Garcia}} \\ \vspace{1pt}
...
{Ph.D. in Computer Science advised by \href{https://dsf.berkeley.edu/jmh/}{\underline{Dr. Joseph M. Hellerstein}}}{Fall 2017 - Summer 2024}{The Management of Context in the Machine Learning Lifecycle}
\resumeSubheading
...
{Undergraduate Researcher, advised by \href{http://epistasis.org/jason-h-moore-phd/}{\underline{Dr. Jason Moore}}
}
...
\item \begin{tabular*}{0.97\textwidth}[t]{l@{\extracolsep{\fill}}r}
  ...
  ACM \textit{CSCW Conf' on Computer Supported Cooperative Work and Social Computing} 2024. & \\
...
\item \begin{tabular*}{0.97\textwidth}[t]{l@{\extracolsep{\fill}}r}
  ...
  Erin M. Kerrison, Aditya G. Parameswaran, Joseph M. Hellerstein. January 2025. & \\
\end{tabular*}\vspace{0pt}
...
\item \begin{tabular*}{0.97\textwidth}[t]{l@{\extracolsep{\fill}}r}
  ...
  \emph{Rolando Garcia}. December 2022. & Golden, CO \\
\end{tabular*}\vspace{0pt}
