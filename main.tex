...
\item \begin{tabular*}{0.97\textwidth}[t]{l@{\extracolsep{\fill}}r}
  \textbf{Your Bookshelf Is a Database: Digitization, Query, and Fair Use in the AI Era} & \emph{CIDR} 2026 \\
  Erick Duarte, Akshit Jain, Jia Zou, K. Selçuk Candan, & \emph{(submitted)}\\ 
  Tyson Winarski, Gary Marchant, \emph{Rolando Garcia}. & \\
