...
\item \begin{tabular*}{0.97\textwidth}[t]{l@{\extracolsep{\fill}}r}
  \textbf{Flow with FlorDB: Incremental Context Maintenance} & \emph{submitted CIDR} 2025 \\
  \textbf{for the Machine Learning Lifecycle} & \\
  \emph{Rolando Garcia}, Pragya Kallanagoudar, Chithra Anand, Sarah E. Chasins, & \\
  Joseph M. Hellerstein, Aditya G. Parameswaran. \textit{submitted CIDR}, 2025.
...
\item \begin{tabular*}{0.97\textwidth}[t]{l@{\extracolsep{\fill}}r}
  ...
  Shreya Shankar, \emph{Rolando Garcia}. San Francisco Bay Area, November 2022. & San Francisco
\end{tabular*}\vspace{0pt}
