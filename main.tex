...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \end{itemize}
    \item NSF TTP-T: \textit{Scalable Human-in-the-Loop Review Systems}, w/ R. Maciejewski, \& T. Winarski\footnote{Sandra Day O'Connor College of Law}
  \end{itemize} 
  \item \emph{In progress}:
  \begin{itemize}
    \item ReviewerApp: Visual Co-Display of LLM and Data Mining Signals, w/ Fan Lei et al.
    \begin{itemize}
      \item Mentoring ASU undergraduate students in computer science (B.S.) Akshit Jain, Rohan Boddu. 
    \end{itemize}
    \item Field Study: Logging \& Record-Keeping Practices in Robotics Research, w/ Erick Duarte et al.
  \end{itemize}
\end{itemize}
